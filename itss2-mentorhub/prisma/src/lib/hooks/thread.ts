...
export function useCheckThread<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { id?: string; title?: string; content?: string; tags?: string; channelId?: string; authorId?: string; isAnonymous?: boolean; pinned?: boolean; closed?: boolean; viewCount?: number }; }, options?: (Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
