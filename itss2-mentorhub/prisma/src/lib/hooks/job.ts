...
export function useCheckJob<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { id?: string; title?: string; description?: string; requirements?: string; benefits?: string; type?: JobType; status?: JobStatus; location?: string; salaryRange?: string; tags?: string; companyId?: string; postedById?: string }; }, options?: (Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
